...
type TestMessage_MsgItem struct {
	...
	ItemType         *TestMessage_ItemType `protobuf:"varint,4,opt,name=itemType,enum=example.TestMessage_ItemType" json:"itemType,omitempty"`
	XXX_unrecognized []byte                `json:"-"`
}
...
func init() {
	proto.RegisterEnum("example.TestMessage_ItemType", TestMessage_ItemType_name, TestMessage_ItemType_value)
}
